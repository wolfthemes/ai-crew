...
def save_to_obsidian(file_path=None, title=None, period=None, report_date=None):
    """
    ...
    if not obsidian_dir:
        print("❌ OBSIDIAN_DIR environment variable not set")
        return False
    
    print(f"Using Obsidian directory: {obsidian_dir}")
    ...
    if not file_path:
        ...
        file_path = f"data/reports/{period}/eurusd_{period}_report_{today}.md"
    ...
    try:
        ...
        print(f"✅ Confirmed directory: {target_dir}")
...
"""
        ...
        print(f"📝 Report saved to Obsidian at {target_file}")
        return True
